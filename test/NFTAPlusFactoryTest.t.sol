...
import {dAgoraNFTAPlusFactory} from "../src/dAgoraFactories/dAgoraNFTAPlusFactory.sol";


contract dAgoraNFTAPlusFactoryTest is Test {
    ...
    function setUp() public {
        ...
        factory = new dAgoraNFTAPlusFactory(address(dAgora));
    ...
    function testCreateNFTAPlusNFT() public {
        vm.startPrank(bob);
