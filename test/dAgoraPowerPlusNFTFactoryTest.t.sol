...
import {dAgoraPowerPlusNFTFactory} from "../src/dAgoraFactories/dAgoraPowerPlusNFTFactory.sol";


contract PowerPlusNFTFactoryTest is Test {
    ...
    dAgoraPowerPlusNFTFactory factory;
    ChainLink link;
    ...
    function setUp() public {
        ...
        factory = new dAgoraPowerPlusNFTFactory(address(dAgora));
    ...
    function testCreatePowerPlusNFT() public {
        vm.startPrank(bob);
    ...
    function testFailWrongTierZero() public {
        vm.startPrank(dAgoraTreasury);
        ...
        function testFailWrongTierOne() public {
        vm.startPrank(dAgoraTreasury);
            dAgora.giftMembership(address(alice), 1, dAgoraMemberships.Membership(1));
        vm.stopPrank();
        vm.startPrank(alice);
            factory.createPowerPlusNFT(
                'TestNFT', 
