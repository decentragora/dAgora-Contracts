...
describe("Test  Create NFTAPlus Factory", function () {
    let proxy: any;
    ...
    beforeEach(async function () {
        ...
        simpleNFTA = await ethers.getContractFactory("NFTAPlus");

        factory = await ethers.getContractFactory("DagoraNFTAPlusFactory");
    ...
    it("Should allow Addr1 to create a new NFT Contract", async function () {
        ...
        await factoryProxy.connect(addr1).createNFTAPlus(
            'TestNFTAPlus',
            'TNFTAPlus',
            'https://dagora.io/nft/',
            10,
    ...
    it("Should not allow a non member to create a new NFT Contract", async function () {
        //Create a new NFT Contract
        await expect(factoryProxy.connect(addr2).createNFTAPlus(
            'TestNFTAPlus',
            'TNFTAPlus',
            'https://dagora.io/nft/',
            10,
    ...
    it("Should revert if factory is paused", async function () {
        ...
        //Create a new NFT Contract
        await expect(factoryProxy.connect(addr1).createNFTAPlus(
            'TestNFTAPlus',
            'TNFTAPlus',
            'https://dagora.io/nft/',
            10,
    ...
    it("Should revert if members tier is below the required tier", async function () {
        await factoryProxy.setMinNFTAPlusTier(3);
        //Create a new NFT Contract
        await expect(factoryProxy.connect(addr1).createNFTAPlus(
            'TestNFTAPlus',
            'TNFTAPlus',
